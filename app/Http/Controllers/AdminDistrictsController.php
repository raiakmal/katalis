<?php namespace App\Http\Controllers;
	...
	class AdminDistrictsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->limit = "20";
			$this->orderby = ["province_id" => "asc", "city_id" => "asc", "name" => "asc"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:100','placeholder'=>'Anda hanya dapat memasukkan huruf saja'];
			$this->form[] = ['label'=>'Kota/Kabupaten','name'=>'city_id','type'=>'select2','validation'=>'required|integer|exists:cities,id','datatable'=>'cities,name'];
			$this->form[] = ['label'=>'Provinsi','name'=>'province_id','type'=>'select2','validation'=>'required|integer|exists:provinces,id','datatable'=>'provinces,name'];
